  ...
  return (
    ...
    >
      <div className='w-48 h-auto flex items-center justify-center relative md:w-24' > 
        <CircularText className={"fill-dark animate-reverse-rotate w-200 dark:fill-light"} />
        <Link href="mailto:kennedy.costa.valenet@gmail.com" className='flex items-center justify-center 
