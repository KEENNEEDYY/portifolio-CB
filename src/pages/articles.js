...
const MovingImg = ({title, img, link}) => {
    ...
    return(
        ...
        >
            ...
            <FramerImage
                style={{x:x, y:y }}
                whileInView={{opacity:1, transition:{duartion: 0.2}}}
                initial={{opacity:0}}
...
const Article = ({img, title, date, link}) => {
    return(
        <motion.li 
            ...
            first:mt-0 border border-solid border-dark dark:border-light border-r-4 border-b-4"
        >
...
const articles = () => {
  return (
    <>
        <Head>
            <title>Desenvolvedor Kennedy | Articles Page</title>
            ...
            <Layout className='pt-16' >
                ...
                <ul className='grid grid-cols-2 gap-16' >
                    <FeaturedArticle 
                      ...
                      summary="Learn how to build a custom pagination component in Reactjs from Scratch. Follow this step-by-step guide to integrate Paginantion component in your ReactJS project."
                      time="9 min read"
